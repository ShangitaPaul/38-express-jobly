...
class Company {
   ...
   * Returns [{ handle, name, description, numEmployees, logoUrl }, ...]
   * */
  // findAll() method accepts and object with a destructuring of properties of name, minEmployees, and maxEmployees and allows for filtering based on user input.
  static async findAll({ name, minEmployees, maxEmployees }) {
    let query = `SELECT *FROM companies`;
  
  // Generate WHERE clause based on user input for filtering
    const queryParams = [];
    if (name !== undefined) {
